(function (global, factory) {
	...
	*/
	...
	function getBoundPosition(draggable /*: Draggable | PositionedDraggable*/, x /*: number*/, y /*: number*/) /*: [number, number]*/ {
	...
	function canDragX(draggable /*: Draggable | PositionedDraggable*/) /*: boolean*/ {
	  return draggable.props.axis === 'both' || draggable.props.axis === 'x';
	}

	function canDragY(draggable /*: Draggable | PositionedDraggable*/) /*: boolean*/ {
	...
	function createDraggableData(draggable /*: Draggable | PositionedDraggable*/, coreData /*: DraggableData*/) /*: DraggableData*/ {
	  return {
	    node: coreData.node,
	...
	var Draggable = function (_React$Component) {
	    ...
	    value: function getDerivedStateFromProps(_ref, _ref2) {
	      ...
	      if (position && (!prevPropsPosition || position.x !== prevPropsPosition.x || position.y !== prevPropsPosition.y)) {
	        return {
	          x: position.x,
	          y: position.y,
	          prevPropsPosition: _extends({}, position)
	        };
	      }
	      return null;
	    }
	  ...
	  function Draggable(props /*: DraggableProps*/) {
	    ...
	    _this.state = {
	      ...
	      isElementSVG: false,
	      prevPropsPosition: _extends({}, props.position)
	    };
	...
	var PositionedDraggable = function (_React$Component) {
	  inherits(PositionedDraggable, _React$Component);
	  createClass(PositionedDraggable, null, [{
	    key: 'getDerivedStateFromProps',
	    value: function getDerivedStateFromProps(_ref, _ref2) {
	      var position = _ref.position;
	      var prevPropsPosition = _ref2.prevPropsPosition;
	  ...
	  function PositionedDraggable(props /*: DraggableProps*/) {
	    classCallCheck(this, PositionedDraggable);

	    var _this = possibleConstructorReturn(this, (PositionedDraggable.__proto__ || Object.getPrototypeOf(PositionedDraggable)).call(this, props));
	  ...
	  createClass(PositionedDraggable, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      // Check to see if the element passed is an instanceof SVGElement
	      if (typeof window.SVGElement !== 'undefined' && ReactDOM.findDOMNode(this) instanceof window.SVGElement) {
	    ...
	    value: function render() /*: ReactElement<any>*/ {
	      ...
	      if (this.state.dragged || this.props.position) {
	        ...
	        var transformOpts = {
	          // Set left if horizontal drag is enabled
	          x: canDragX(this) && draggable ? this.state.x : _position.x,

	          // Set top if vertical drag is enabled
	          y: canDragY(this) && draggable ? this.state.y : _position.y
	        };
	...
	PositionedDraggable.displayName = 'Draggable';
	PositionedDraggable.propTypes = _extends({}, DraggableCore.propTypes, {
	...
	PositionedDraggable.defaultProps = _extends({}, DraggableCore.defaultProps, {
	  axis: 'both',
	  bounds: false,
	  defaultClassName: 'react-draggable',
	  defaultClassNameDragging: 'react-draggable-dragging',
